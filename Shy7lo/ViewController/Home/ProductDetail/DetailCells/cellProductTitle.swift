...
class cellProductTitle: UITableViewCell {
    ...
    @IBOutlet weak var viewDouble: UIView!
    
    @IBOutlet weak var lblStaticColor: UILabel!
    ...
    func setUpUI()
    {
        if isEnglish
        {
           ...
           // btnStaticSize.transform = CGAffineTransform.identity
            lblStaticColor.transform = CGAffineTransform.identity
        ...
        else
        {
           ...
           // btnStaticSize.transform = CGAffineTransform.init(scaleX: -1.0, y: 1.0)
             lblStaticColor.transform = CGAffineTransform.init(scaleX: -1.0, y: 1.0)
