...
- (id)initWithCoder:(NSCoder *)aDecoder{
    ...
    if (self) {
        if (IS_WIDESCREEN) {
            ...
            {
                //six height 667
                [self setFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height-52)];
                //[UIScreen mainScreen].bounds.size.height-55
            }
            else if ([UIScreen mainScreen].bounds.size.width==414)
            {
                //six height 736
                [self setFrame:CGRectMake(0, 0, [UIScreen mainScreen].bounds.size.width, [UIScreen mainScreen].bounds.size.height-57)];
            }
        }
        [self initialize];
    }
