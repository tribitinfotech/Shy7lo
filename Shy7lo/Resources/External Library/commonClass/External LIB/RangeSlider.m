...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _trackBackground = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"bg_slider_bar.png"]] autorelease];
        _trackBackground.center = self.center;
        _trackBackground.frame = CGRectMake(frame.origin.x + 10, _trackBackground.frame.origin.y, frame.size.width - 20, _trackBackground.frame.size.height);
        [self addSubview:_trackBackground];
        
        _track = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"bg_slider_bar.png"]] autorelease];
        _track.center = self.center;
        _track.frame = CGRectMake(frame.origin.x, _track.frame.origin.y, frame.size.width, _track.frame.size.height);
        [self addSubview:_track];
        
        _minThumb = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"bg_slider_handler.png"] highlightedImage:[UIImage imageNamed:@"bg_slider_handler.png"]] autorelease];
        ...
        _maxThumb = [[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"bg_slider_handler.png"] highlightedImage:[UIImage imageNamed:@"bg_slider_handler.png"]] autorelease];
