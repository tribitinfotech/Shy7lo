...
let ARS_CIRCLE_ROTATION_TO_VALUE = 2 * CGFloat(M_PI)
let ARS_CIRCLE_ROTATION_REPEAT_COUNT = Float(UINT64_MAX)
let ARS_CIRCLE_RADIUS_OUTER: CGFloat = 30.0
let ARS_CIRCLE_RADIUS_MIDDLE: CGFloat = 20.0
let ARS_CIRCLE_RADIUS_INNER: CGFloat = 10.0
let ARS_CIRCLE_LINE_WIDTH: CGFloat = 2.0
let ARS_CIRCLE_START_ANGLE: CGFloat = -CGFloat(M_PI_2)
